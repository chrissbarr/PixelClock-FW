#ifndef __INC_PLIB8TION_TRIG_H
#define __INC_PLIB8TION_TRIG_H
...
__LIB8STATIC int16_t sin16_avr( uint16_t theta )
{
...
/// @param theta input angle from 0-65535
/// @returns sin of theta, value between -32767 to 32767.
__LIB8STATIC int16_t sin16_C( uint16_t theta )
{
...
__LIB8STATIC int16_t cos16( uint16_t theta)
{
...
__LIB8STATIC uint8_t  sin8_avr( uint8_t theta)
{
...
/// @param theta input angle from 0-255
/// @returns sin of theta, value between 0 and 255
__LIB8STATIC uint8_t sin8_C( uint8_t theta)
{
    uint8_t offset = theta;
    if( theta & 0x40 ) {
...
__LIB8STATIC uint8_t cos8( uint8_t theta)
{
