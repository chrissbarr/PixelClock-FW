...
BrightnessSensor::BrightnessSensor() 
{
  ...
  if (sensor) {
    ...
    Serial.print("Sensor ID: "); Serial.println(sensor->getID(), HEX);
    ...
    if (!sensor->measure()) {
      ...
      Serial.print("Irradiance: "); Serial.print(sensor->getIrradiance(), 7); Serial.println(" W / m^2");
      Serial.print("Brightness: "); Serial.print(sensor->getBrightness(), 7); Serial.println(" lux");
    }
  }
}
